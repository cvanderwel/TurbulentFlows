%% Turbulence: Ch7 Free shear flows - 2D planar wake data
...
opts = detectImportOptions('Exercise7_2Data.txt');
preview('Exercise7_2Data.txt',opts)

% load the data
[index, y_list, U_list, V_list, uu_list, vv_list, uv_list] = readvars('Exercise7_2Data.txt');
