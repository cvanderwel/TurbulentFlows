%% Turbulence: Ch7 Internal Flows - Channel Flow
...
opts = detectImportOptions('ChannelData.txt','FileType','text');
opts.SelectedVariableNames = [2 3]; % In this exercise we just need column 2 and 3
preview('ChannelData.txt',opts)

% load the data
[yplus,Uplus] = readvars('ChannelData.txt',opts);
