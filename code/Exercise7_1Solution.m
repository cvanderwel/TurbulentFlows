%% Turbulence: Ch7 Free shear flows - 2D mixing layer data
...
opts = detectImportOptions('Exercise7_1Data.txt');
preview('Exercise7_1Data.txt',opts)

% load the data
[Y, U, uv, k, epsilon] = readvars('Exercise7_1Data.txt');
