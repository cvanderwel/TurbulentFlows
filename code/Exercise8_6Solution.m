%% Turbulence: Ch8 Internal Flows - Pipe Flow
...
opts = detectImportOptions('Exercise8_6Data.txt','FileType','text');
preview('Exercise8_6Data.txt',opts)

% load the data
[ys,rs,udef,yplus,Uplus] = readvars('Exercise8_6Data.txt',opts);
